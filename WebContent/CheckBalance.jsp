                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Account Balance</a>
                                </li>
...
<table class="table table-dark">
  <tbody>
    ...
    <tr>
      ...
      <td><% out.println(rs.getInt(5)+" <small> BDT<//small>"); %></td>
    </tr>
    <tr>
      <th scope="row">Total Transaction :</th>
      <td><% out.println(rs.getInt(6)+" <small> BDT<//small>"); %></td>
    </tr>
  </tbody>
</table>
                                   </div>
